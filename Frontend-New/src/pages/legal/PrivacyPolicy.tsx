...
import { Shield, Book, FileText, Lock, Clock, User, TrendingUp, TrendingDown, Sparkles, CircleDashed, CircleWavy, CircleDashed2, CircleWavy2, CircleDot, CircleDot2, ArrowRight } from 'lucide-react';
