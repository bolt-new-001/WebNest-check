...
export default function AuthClientPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.message || 'Invalid credentials. Try test@example.com / password');
        } finally {
            setLoading(false);
        }
    };
    ...
    const buttonVariants = {
        idle: { scale: 1, boxShadow: "0 4px 20px rgba(236, 72, 153, 0.3)" },
        hover: {
            scale: 1.05,
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden flex items-center justify-center p-4">
            ...
            <div className="absolute inset-0">
                {/* Gradient Orbs */}
                <motion.div
                    className="absolute top-20 left-20 w-96 h-96 bg-gradient-to-r from-pink-500/20 to-orange-500/20 rounded-full blur-3xl"
                    animate={{
                        scale: [1, 1.2, 1],
                        opacity: [0.3, 0.6, 0.3],
                        x: [0, 50, 0],
            ...
            >
                ...
                >
                    <motion.div
                        className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-pink-500 to-orange-600 shadow-lg mb-6"
                    ...
                    <p className="text-white/80">Sign in to your client dashboard</p>
                </motion.div>
                ...
                >
                    ...
                    <div className="space-y-6">
                        ...
                        <motion.button
                            ...
                            className="w-full py-4 rounded-2xl bg-gradient-to-r from-pink-500 to-orange-600 text-white font-semibold text-lg shadow-lg disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group"
                        >
                            <AnimatePresence mode="wait">
                                {loading ? (
                                    <motion.div
                            ...
                            {/* Button Glow Effect */}
                            <motion.div
                                className="absolute inset-0 bg-gradient-to-r from-pink-400 to-orange-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl"
                            />
                        </motion.button>
                        ...
                        >
                            ...
                            <a href="/auth/register" className="text-pink-400 hover:text-pink-300 ml-1 font-medium transition-colors duration-200">
                                Sign up
                            </a>
                        </motion.div>
                    </div>
                ...
                >
                    {[
                        ...
                        { icon: Globe, text: "Global", color: "text-blue-400" },
                        { icon: Sparkles, text: "Premium", color: "text-yellow-400" }
                    ].map((feature, index) => (
                        <motion.div
                            key={index}
                    ...
                    >
                        ...
                        >
                            <motion.div
                                ...
                                className="w-20 h-20 rounded-full bg-gradient-to-r from-green-500 to-emerald-600 flex items-center justify-center mx-auto mb-6 shadow-2xl"
                            >
