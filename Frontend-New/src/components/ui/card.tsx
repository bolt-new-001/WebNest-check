...
>(({ className, hover = false, gradient = false, children, ...props }, ref) => (
  <motion.div
    ...
    className={cn(
      "rounded-2xl border border-neutral-200 bg-white text-card-foreground shadow-soft",
      hover && "hover:shadow-soft-lg transition-all duration-300 cursor-pointer",
      gradient && "gradient-soft border-white/20",
      className
    )}
    {...props}
  >
